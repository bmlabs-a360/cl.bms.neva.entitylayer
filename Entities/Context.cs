...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("pk_alternativa_id");
            ...
            entity.HasOne(d => d.Evaluacion).WithMany(p => p.Alternativas)
                .HasForeignKey(d => d.EvaluacionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_alternativa_evaluacion_id");

            entity.HasOne(d => d.Pregunta).WithMany(p => p.Alternativas)
        ...
        {
            entity.HasKey(e => e.Id).HasName("pk_bitacora_id");
        ...
        {
            entity.HasKey(e => e.Id).HasName("pk_control_token_id");
        ...
        {
            entity.HasKey(e => e.Id).HasName("pk_empresa_id");

            entity.ToTable("empresa");

            entity.HasIndex(e => e.RutEmpresa, "rut_empresa_unique").IsUnique();

            entity.HasIndex(e => e.RazonSocial, "un_empresa_razon_social").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("pk_evaluacion_id");

            entity.ToTable("evaluacion");

            entity.HasIndex(e => e.Nombre, "un_evaluacion_razon_nombre").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("pk_evaluacion_empresa_id");
            ...
            entity.Property(e => e.FechaCreacion)
                ...
                .HasColumnType("timestamp without time zone")
                .HasColumnName("fecha_creacion");
            entity.Property(e => e.FechaInicioTiempoLimite)
                .HasColumnType("timestamp without time zone")
                .HasColumnName("fecha_inicio_tiempo_limite");

            entity.HasOne(d => d.Empresa).WithMany(p => p.EvaluacionEmpresas)
                .HasForeignKey(d => d.EmpresaId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_evaluacion_empresa_empresa_id");

            entity.HasOne(d => d.Evaluacion).WithMany(p => p.EvaluacionEmpresas)
                .HasForeignKey(d => d.EvaluacionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.Id).HasName("pk_importancia_estrategica_id");
            ...
            entity.HasOne(d => d.ImportanciaRelativa).WithMany(p => p.ImportanciaEstrategicas)
                .HasForeignKey(d => d.ImportanciaRelativaId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_importancia_estrategica_id");

            entity.HasOne(d => d.SegmentacionSubArea).WithMany(p => p.ImportanciaEstrategicas)
        ...
        {
            entity.HasKey(e => e.Id).HasName("pk_importancia_relativa_id");
            ...
            entity.HasOne(d => d.EvaluacionEmpresa).WithMany(p => p.ImportanciaRelativas)
                .HasForeignKey(d => d.EvaluacionEmpresaId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_importancia_relativa_evaluacion_empresa_id");

            entity.HasOne(d => d.SegmentacionArea).WithMany(p => p.ImportanciaRelativas)
        ...
        modelBuilder.Entity<Perfil>(entity =>
        {
            ...
            entity.HasIndex(e => e.Nombre, "un_perfil").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("pk_perfil_permiso");

            entity.ToTable("perfil_permiso");

            entity.HasIndex(e => new { e.PerfilId, e.Nombre, e.Detalle }, "un_perfil_permiso").IsUnique();
            ...
            entity.HasOne(d => d.Perfil).WithMany(p => p.PerfilPermisos)
        ...
        {
            entity.HasKey(e => e.Id).HasName("pk_plan_mejora_id");
            ...
            entity.HasOne(d => d.Alternativa).WithMany(p => p.PlanMejoras)
            ...
            entity.HasOne(d => d.SegmentacionSubArea).WithMany(p => p.PlanMejoras)
                .HasForeignKey(d => d.SegmentacionSubAreaId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_plan_mejora_segmentacion_sub_area_id");

            entity.HasOne(d => d.TipoDiferenciaRelacionada).WithMany(p => p.PlanMejoras)
                .HasForeignKey(d => d.TipoDiferenciaRelacionadaId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_plan_mejora_tipo_diferencia_relacionada_id");

            entity.HasOne(d => d.TipoImportancia).WithMany(p => p.PlanMejoras)
        ...
        {
            entity.HasKey(e => e.Id).HasName("pk_pregunta_id");
            ...
            entity.HasOne(d => d.SegmentacionArea).WithMany(p => p.Pregunta)
                .HasForeignKey(d => d.SegmentacionAreaId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_pregunta_segmentacion_area_id");

            entity.HasOne(d => d.SegmentacionSubArea).WithMany(p => p.Pregunta)
                .HasForeignKey(d => d.SegmentacionSubAreaId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.Id).HasName("pk_reporte_id");
            ...
            entity.HasOne(d => d.Evaluacion).WithMany(p => p.Reportes)
                .HasForeignKey(d => d.EvaluacionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.Id).HasName("pk_reporte_area_id");
            ...
            entity.HasOne(d => d.Reporte).WithMany(p => p.ReporteAreas)
                .HasForeignKey(d => d.ReporteId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_reporte_area_reporte_id");

            entity.HasOne(d => d.SegmentacionArea).WithMany(p => p.ReporteAreas)
                .HasForeignKey(d => d.SegmentacionAreaId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.Id).HasName("pk_reporte_item_id");
            ...
            entity.HasOne(d => d.Reporte).WithMany(p => p.ReporteItems)
                .HasForeignKey(d => d.ReporteId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_reporte_item_reporte_id");

            entity.HasOne(d => d.TipoItemReporte).WithMany(p => p.ReporteItems)
        ...
        {
            entity.HasKey(e => e.Id).HasName("pk_respuesta_id");
            ...
            entity.HasOne(d => d.Alternativa).WithMany(p => p.Respuesta)
                .HasForeignKey(d => d.AlternativaId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_respuesta_alternativa_id");

            entity.HasOne(d => d.EvaluacionEmpresa).WithMany(p => p.Respuesta)
                .HasForeignKey(d => d.EvaluacionEmpresaId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.Id).HasName("pk_segmentacion_area_id");
            ...
            entity.HasOne(d => d.Evaluacion).WithMany(p => p.SegmentacionAreas)
                .HasForeignKey(d => d.EvaluacionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.Id).HasName("pk_segmentacion_sub_area_id");
            ...
            entity.HasOne(d => d.SegmentacionArea).WithMany(p => p.SegmentacionSubAreas)
                .HasForeignKey(d => d.SegmentacionAreaId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.Id).HasName("pk_seguimiento_id");
            ...
            entity.HasOne(d => d.Empresa).WithMany(p => p.Seguimientos)
                .HasForeignKey(d => d.EmpresaId)
                .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            entity.HasOne(d => d.PlanMejora).WithMany(p => p.Seguimientos)
        ...
        {
            entity.HasKey(e => e.Id).HasName("pk_tipo_cantidad_empleado_id");
        ...
        {
            entity.HasKey(e => e.Id).HasName("pk_tipo_diferencia_relacionada");
        ...
        {
            entity.HasKey(e => e.Id).HasName("pk_tipo_importancia");
        ...
        {
            entity.HasKey(e => e.Id).HasName("pk_tipo_item_reporte");
        ...
        {
            entity.HasKey(e => e.Id).HasName("pk_tipo_nivel_venta_id");
        ...
        {
            entity.HasKey(e => e.Id).HasName("pk_tipo_rubro_id");
        ...
        {
            entity.HasKey(e => e.Id).HasName("pk_tipo_sub_rubro_id");
            ...
            entity.HasOne(d => d.TipoRubro).WithMany(p => p.TipoSubRubros)
                .HasForeignKey(d => d.TipoRubroId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.Id).HasName("pk_tipo_tamano_empresa_id");
        ...
        modelBuilder.Entity<Usuario>(entity =>
        {
            ...
            entity.HasIndex(e => e.Email, "un_usuario_email").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("pk_usuario_area_id");
            ...
            entity.HasOne(d => d.SegmentacionArea).WithMany(p => p.UsuarioAreas)
                .HasForeignKey(d => d.SegmentacionAreaId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_usuario_area_segmentacion_area_id");

            entity.HasOne(d => d.UsuarioEvaluacion).WithMany(p => p.UsuarioAreas)
        ...
        {
            entity.HasKey(e => e.Id).HasName("pk_usuario_empresa_id");
            ...
            entity.HasOne(d => d.Empresa).WithMany(p => p.UsuarioEmpresas)
                .HasForeignKey(d => d.EmpresaId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_usuario_empresa_empresa_id");

            entity.HasOne(d => d.Usuario).WithMany(p => p.UsuarioEmpresas)
                .HasForeignKey(d => d.UsuarioId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.Id).HasName("pk_usuario_evaluacion_id");
            ...
            entity.HasOne(d => d.Empresa).WithMany(p => p.UsuarioEvaluacions)
                .HasForeignKey(d => d.EmpresaId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_usuario_evaluacion_empresa_id");

            entity.HasOne(d => d.Evaluacion).WithMany(p => p.UsuarioEvaluacions)
                .HasForeignKey(d => d.EvaluacionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_usuario_evaluacion_evaluacion_id");

            entity.HasOne(d => d.Usuario).WithMany(p => p.UsuarioEvaluacions)
                .HasForeignKey(d => d.UsuarioId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.Id).HasName("pk_usuario_suscripcion_id");
            ...
            entity.Property(e => e.TiempoSuscripcion)
                .HasColumnType("timestamp without time zone")
                .HasColumnName("tiempo_suscripcion");
            entity.Property(e => e.UsuarioId).HasColumnName("usuario_id");

            entity.HasOne(d => d.Usuario).WithMany(p => p.UsuarioSuscripcions)
                .HasForeignKey(d => d.UsuarioId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_usuario_empresa_usuario_id");
        });
